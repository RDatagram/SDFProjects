...
define(['N/record', 'N/search', 'N/file', 'N/runtime', 'N/log'], function (record, search, file, runtime, log) {
  ...
  function getEntityForJournal(customerId, entities) {
    for (var entityId in entities) {
      if (entities[entityId].type === 'Vendor' && entities[entityId].entityid === customerId) {
 ...
 */
   ...
   */
  function createKUFSearch(from, to, subsidiaryId) {
  ...
  function getInputData() {
    try {
      ...
      var kufSavedSearch = createKUFSearch(from, to, subsidiaryId);
