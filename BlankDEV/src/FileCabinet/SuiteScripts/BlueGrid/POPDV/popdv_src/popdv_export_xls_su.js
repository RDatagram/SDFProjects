 ...
 */
define(["N/render", "N/config", "N/log", "N/file", './popdvUtil', 'N/record', 'N/file', 'N/encode'], function (render, config, log, file, popdvUtil, record, file, encode) {
  ...
  function onRequest(context) {
    ...
    var xlsFile = file.create({
      name: 'POPDV_za_period_' + dateStart + '-' + dateEnd + '.xls',
