...
define(['N/currentRecord', 'N/ui/message', 'N/url', 'N/https', 'N/record'], function (currentRecord, message, url, https, record) {
  ...
  function fieldChanged(scriptContext) {
    if (scriptContext.fieldId === 'custrecord_rsm_ior_report_subsidiary') {
      ...
      if (subsidiaryId) {
        ...
        reportRecord.setValue({
          fieldId: 'custrecord_rsm_ior_report_pib',
          value: pib
        })
        reportRecord.setValue({
          fieldId: 'custrecord_rsm_ior_report_maticni_broj',
          value: matBroj
        })
      }
    }
  ...
  function callRestlet(myAction) {
    ...
    var scriptId = 'customscript_finansijski_ostali_ior_rl';
    var deploymentId = 'customdeploy_finansijski_ostali_ior_rl';
  ...
  return {
    ...
    init_ior_lines: init_ior_lines,
    getXmlFile: getXmlFile,
    getPdfFile: getPdfFile,
    calculate_ior_lines: calculate_ior_lines,
