...
define(['N/currentRecord', 'N/ui/message', 'N/url', 'N/https', 'N/record'], function(currentRecord, message, url, https, record) {
  ...
  function fieldChanged(scriptContext) {
    if (scriptContext.fieldId === 'custrecord_rsm_cf_report_subsidiary') {
      ...
      if (subsidiaryId) {
        ...
        console.log(JSON.stringify({pib: pib, matBroj: matBroj}));

        reportRecord.setValue({
          fieldId: 'custrecord_rsm_cf_report_pib',
          value: pib
        })
        reportRecord.setValue({
          fieldId: 'custrecord_rsm_cf_report_maticni_broj',
          value: matBroj
        })
      }
    }
  ...
  function callRestlet(myAction) {
    ...
    var scriptId = 'customscript_rl_cf_report';
    var deploymentId = 'customdeploy_rl_cf_report';
  ...
  return {
    ...
    init_cf_lines: init_cf_lines,
    getXmlFile: getXmlFile,
    getPdfFile: getPdfFile,
    calculate_cf_lines: calculate_cf_lines,
