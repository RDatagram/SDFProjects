...
define(['N/currentRecord', 'N/ui/message', 'N/url', 'N/https', 'N/search', 'N/record'], function(currentRecord, message, url, https, search, record) {
  ...
  function fieldChanged(scriptContext) {
    if (scriptContext.fieldId === 'custrecord_rsm_pk_report_subsidiary') {
      ...
      if (subsidiaryId) {
        ...
        reportRecord.setValue({
          fieldId: 'custrecord_rsm_pk_report_pib',
          value: pib
        })
        reportRecord.setValue({
          fieldId: 'custrecord_rsm_pk_report_maticni_broj',
          value: matBroj
        })
      }
    }
  ...
  function callRestlet(myAction) {
    ...
    var scriptId = 'customscript_rsm_rl_pk_report';
    var deploymentId = 'customdeploy_rsm_rl_pk_report';
  ...
  return {
    ...
    init_pk_lines: init_pk_lines,
    getXmlFile: getXmlFile,
    getPdfFile: getPdfFile,
    calculate_pk_lines: calculate_pk_lines,
