 ...
 */
define(['N/log', 'N/ui/serverWidget', 'N/record'], function (log, ui, record) {
  ...
  function onRequest(context) {
    if (context.request.method === 'GET') {
      ...
      iterator.each(function (line) {
        ...
        var description = parsedLine[0].replace(/"/g, '');
        var aopCode = parsedLine[1].replace(/"/g, '');
        ...
        newRecord.setValue({
          fieldId: 'custrecord_rsm_aop_pk_code_description',
          value: description
        });
  ...
  function showForm() {
    var form = ui.createForm({
      title: 'Inicijalizacija aop kodova za izveštaj o promenama na kapitalu'
    });
