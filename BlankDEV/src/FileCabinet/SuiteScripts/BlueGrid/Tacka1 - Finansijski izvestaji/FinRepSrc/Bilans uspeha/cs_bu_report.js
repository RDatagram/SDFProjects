...
define(['N/currentRecord', 'N/ui/message', 'N/url', 'N/https', 'N/record'], function(currentRecord, message, url, https, record) {
    ...
    function fieldChanged(scriptContext) {
        if (scriptContext.fieldId === 'custrecord_rsm_bu_report_subsidiary') {
            ...
            if (subsidiaryId) {
                ...
                reportRecord.setValue({
                    fieldId: 'custrecord_rsm_bu_report_pib',
                    value: pib
                })
                reportRecord.setValue({
                    fieldId: 'custrecord_rsm_bu_report_maticni_broj',
                    value: matBroj
                })
            }
        }
