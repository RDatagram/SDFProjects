 ...
 * 
 * OA1 Asset amortization form suitelet
 * 
 ...
 * 
 * On POST request year value is submited and page redirects to 'customscript_asset_amortization_oa1_su' suitelet
 * 
 */
  ...
  function onRequest(context) {
    ...
    if (context.request.method === "GET") {
      ...
      context.response.sendRedirect({
        ...
        identifier: "customscript_oa1_su",
        id: "customdeploy_oa1_su",
        parameters: {
