 ...
 * 
 * This Suitelet script generates XLS file which represents OAN Asset amortization report form.
 * 
...
define(["N/search", "N/util", "N/file", "N/encode", "N/log", "./dateUtil"], function (search, util, file, encode, log, dateUtil) {
    ...
    var customrecord_ncfar_deprhistorySearchObj = search.create({
      ...
      filters:
        [
          ...
          "AND",
          ["custrecord_deprhistasset.custrecord_rsm_fam_grupa_sredstva", "anyof", "6"],
          "AND",
  ...
  function createXlsFile(year) {
    ...
    xmlString += '<Worksheet ss:Name="OAN">';
    xmlString += '<Table>' +
      '<Row>' +
