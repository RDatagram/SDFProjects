...
define([ 'N/ui/serverWidget', 'N/task' ],
    ...
    function(serverWidget, task) {
        ...
        function beforeLoad(scriptContext) {
            ...
            form.clientScriptModulePath = "./rsm_ccard_cs.js";
            ...
            if (scriptContext.type === scriptContext.UserEventType.VIEW) {
                ...
                var btnReset = form.addButton({
                    id : "custpage_submit_reset_button",
                    label : 'Reset',
                    functionName : 'submit_reset()'
                })
                ...
                var fCrdlLinesCount = cRec.getValue('custrecord_rsm_crdh_line_count');

                try {
                    var cStatus;
                    cStatus = task.checkStatus(cRec.getValue('custrecord_rsm_crdh_parser_mr'));
                ...
                try {
                    var cStatus;
                    cStatus = task.checkStatus(cRec.getValue('custrecord_rsm_crdh_payment_mr'));
