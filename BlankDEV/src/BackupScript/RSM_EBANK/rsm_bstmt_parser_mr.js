...
define(
		...
		function(record, runtime, query, task, format, util_parsers, searchModule) {
			...
			function getInputData() {
				...
				myOptions.fileId = recMaster.getValue('custrecord_rsm_bstmt_file');
				myOptions.parser = recMaster.getText('custrecord_rsm_bstmt_parser');
				myOptions.subsidiary = recMaster.getValue('custrecord_rsm_bstmt_subsidiary');
				*/
				...
				// TODO update rsm_bstmt map/reduce.id field
