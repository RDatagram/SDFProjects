...
define(["N/config", "N/log"], function (config, log) {
    ...
    var dateUtil = {
        ...
        resolveDepreciationStartDate: function(praviloAmortizacije, datumNabavke) {
            var datumPocetkaAmortizacije;
            switch (praviloAmortizacije) {
                // Prvi narednog meseca
                // First of next month
                case "Disposal":
                    var month = dateUtil.getMonth(datumNabavke);
                    var year = dateUtil.getYear(datumNabavke);
                    var newMonth, year;
                    if (month + 1 === 13) {
                        newMonth = 1;
                        year = year + 1;
                    ...
                    datumPocetkaAmortizacije = dateUtil.createNewDateString(1, newMonth, year);
                    break;
                ...
                case "Acquisition":
                    var year = dateUtil.getYear(datumNabavke);
                    var month = dateUtil.getMonth(datumNabavke);
                    datumPocetkaAmortizacije = dateUtil.createNewDateString(1, month, year);
                    break;
                ...
                case "Mid-month":
                    var year = dateUtil.getYear(datumNabavke);
                    var month = dateUtil.getMonth(datumNabavke);
                    var day = dateUtil.getDay(datumNabavke);
                ...
                case "Pro-rata":
                    ...
                    datumPocetkaAmortizacije = datumNabavke;
                    break;
                default:
                    // TODO
                    break;
            }
            return datumPocetkaAmortizacije;
        },
