...
define(['N/file', 'N/record', 'N/format', 'N/runtime'],
    ...
    (file, recordModule, format, runtime) => {
        ...
        const _csv_parser = (context) => {
            ...
            courierLineIterator.each(function (line) {
                ...
                if (lineElements.length === 1) { // Skip the lines that are empty
                    ...
                    transaction.v_internalid = lineElements[0].trim();
                    transaction.v_trandate = lineElements[1].trim();
        ...
        const getInputData = (inputContext) => {
            ...
            myOptions.fileId = scriptObj.getParameter('custscript_rsm_update_cd_file');
...
*/
        ...
        const map = (mapContext) => {
            ...
            log.debug({
                title : 'result.v_internalid',
                details : result.v_internalid
            });

            let cpRec = recordModule.load({
                type: 'customerdeposit',
                id : result.v_internalid,
                isDynamic: true
            });
