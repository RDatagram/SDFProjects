    ...
    function (searchModule) {
        ...
        function doPost(requestBody) {
            ...
            mySearch = searchModule.create({
                type: "transaction",
                filters: [
                    {"name": "type", "operator": "anyof", "values": ["CustPymt"]},
                    ...
                    {"name": "custbody_rsm_invoice_old_crm_id", join:"appliedToTransaction", "operator": searchModule.Operator.ISNOTEMPTY, "values":[]}
            ...
            util.each(results, function (result) {
                ...
                if (result.recordType === 'customerpayment') {
                    if (result.getValue({name: 'line'}) === "0") {
                        ...
                        if (result.getValue({name : 'custbody_rsm_invoice_old_crm_id', join: "appliedToTransaction"})) {
                            var retPymt = {
